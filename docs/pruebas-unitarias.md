...
description: Documentación del sistema de pruebas unitarias del proyecto WeekBalance
order: 2
---
...
4. [Tipo de Pruebas Implementadas](#tipo-de-pruebas-implementadas)
5. [Herramientas y Configuración](#herramientas-y-configuración)
6. [Flujo de Ejecución de una Prueba](#flujo-de-ejecución-de-una-prueba)
7. [Pruebas con Mocks](#pruebas-con-mocks)
8. [Tipos de Casos Probados](#tipos-de-casos-probados)
9. [Ejemplos de Pruebas](#ejemplos-de-pruebas)
...
### Configuración de Mocks en Tests
