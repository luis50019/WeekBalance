...
function CardCurrentFound({
  ...
  return (
    <LinearGradient
      ...
      style={CardCurrentFoundStyle.container}
    >
      ...
      <View style={CardCurrentFoundStyle.body}>
        <Text style={CardCurrentFoundStyle.bodyAmount}>
          $ {balance.toFixed(2)}
        </Text>
      </View>
      ...
      <View style={CardCurrentFoundStyle.buttonActions}>
        <View style={CardCurrentFoundStyle.infoMoney}>
          <Text style={CardCurrentFoundStyle.infoMoneyTitle}>
            Total de ingresos
          </Text>
          <Text style={CardCurrentFoundStyle.infoMoneyTitleValue}>
            $ {incomes.toFixed(2)}
          </Text>
        </View>
        <View style={CardCurrentFoundStyle.infoMoney}>
